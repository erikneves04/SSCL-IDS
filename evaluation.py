...
if __name__ == "__main__":
    ...
    ckpt = torch.load(os.path.join(chk_dir, args.model_chkpt), map_location=torch.device('cpu'))
    ...
    if args.train_from_scratch:
        train_normal_df = load_pandas_df(os.path.join(main_dir, "tmp_folder/iot23-mirai-7-1-processed_training_normalflows.csv"))#+args.test_dataset_name))
    else:
        print('Aqui')
